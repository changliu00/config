...
# sudo useradd -G sudo -m changliu
# sudo passwd changliu
# sudo chown -R chang /home/changliu
# sudo mkdir /home/changliu/.ssh
## run on local: `scp ~/.ssh/* changliu@hostname:/home/changliu/.ssh/`
## run on local: `cat ~/.ssh/id_ed25519.pub | ssh username@hostname 'cat >> .ssh/authorized_keys'`
# sudo chmod 600 /home/chang/.ssh/*
...
sudo apt update
sudo apt install --upgrade git tmux ripgrep build-essential cmake python3.12 python3-pip python3-dev
sudo apt upgrade
